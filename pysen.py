...
def build_site():
  ...
  site_ctx = {
      ...
      "display_name": "Verse",
      "tagline": "",
      "footer": f'Copyright © 2023 <a href="https://hasithsen.pages.dev" class="text-decoration-none">hsen</a>. Powered by <a href="https://github.com/hasithsen/pysen" class="text-decoration-none">Pysen</a>.',
  }
